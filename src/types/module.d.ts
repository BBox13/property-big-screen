...
import type { addDateRange, handleTree, selectDictLabel, selectDictLabels, parseTime, handleQueryOrder } from '@/utils/ruoyi';
import type { getConfigKey, updateConfigByKey } from '@/api/system/config';
import type { download as rd } from '@/utils/request';
import type { containPermission } from '@/directive/permission';
...
declare module 'vue' {
  interface ComponentCustomProperties {
    ...
    hasPermi: typeof containPermission;
    handleQueryOrder: typeof handleQueryOrder;
  }
}
