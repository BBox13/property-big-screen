<template>
  <div class="m-t-30px h-268px flex flex-col items-end justify-between">
    <div class="relative h-50px w-383px">
      ...
      <div class="absolute bottom-6px left-16px text-26px color-#fff">
        <span> 安保巡检 </span>
        <span class="m-l-6px text-10px"> Security inspection </span>
      </div>
    </div>
    <div class="relative m-t-20px h-376px w-100% flex flex-col items-center">
      <div class="w-384px flex items-center justify-between">
      ...
      <div class="relative m-r-160px m-t--30px">
        <pie3DSecond :data="pieData" />
        <div class="button-bg absolute right-10px top-205px m-t-5px h-13px w-40px flex items-center text-10px color-#fff line-height-13px">
