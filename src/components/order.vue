  ...
  <div>
    <div class="relative h-50px">
      ...
      <div class="absolute bottom-6px left-16px text-26px color-#fff">
        <span> 报修工单 </span>
        <span class="text-14px"> Warranty Work Order </span>
      </div>
    </div>
    <div class="m-t-24px h-404px w-479px flex flex-col items-center border color-#fff">
      <div class="m-t-24px w-440px flex justify-between">
        <div class="order-1 h-87px w-96px flex flex-col items-center">
          <span class="m-t-10px text-14.5px color-#1afcff font-900">1780</span>
          <span>工单总数</span>
        </div>
        <div class="order-2 h-87px w-96px flex flex-col items-center">
          <span class="m-t-10px text-14.5px color-#07ffcd font-900">879%</span>
          <span>完成率</span>
        </div>
        <div class="order-3 h-87px w-96px flex flex-col items-center">
          <span class="m-t-10px text-14.5px color-#bb36c0 font-900">87%</span>
          <span>客户投诉量</span>
        </div>
        <div class="order-4 h-87px w-96px flex flex-col items-center">
          <span class="m-t-10px text-14.5px color-#fca8a8 font-900">87</span>
          <span>周品检整改量</span>
        </div>
      </div>
      <div class="m-t-10px w-440px flex">
        <div class="relative m-l-10px">
          <div ref="leftRef" class="h-130px w-130px"></div>
          <div class="absolute left-45px top-65px flex flex-col items-center color-#00edff">
            <span class="text-21px">50%</span>
            <span class="m-t--4px text-12px">回访</span>
          </div>
          <div class="border-img absolute left-120px top-45px h-35px w-80px flex">
        ...
        <div class="relative m-l-100px">
          <div ref="rightRef" class="h-130px w-130px"></div>
          <div class="absolute left-45px top-65px flex flex-col items-center color-#ffd725">
            <span class="text-21px">50%</span>
      ...
      <div class="relative m--40px">
        <div ref="acrossRef" class="h-190px w-440px"></div>
        <div class="absolute left-20px top-20px w-400px flex items-center justify-between">
          ...
          <div class="button-bg m-t-5px h-13px w-40px flex items-center text-10px color-#fff line-height-13px">
...
.order-1{
    background-image: url('@/assets/order-1.png');
}
.order-2{
    background-image: url('@/assets/order-2.png');
}
.order-3{
    background-image: url('@/assets/order-3.png');
}
.order-4{
    background-image: url('@/assets/order-4.png');
}
